...
- معايير أساسية بلا حالة اختبار: C091
- إجمالي المعايير المغطاة باختبار واحد على الأقل: 46/55
- عدد حالات الاختبار: 44
...
- evidence: 44 حالة اختبار تغطي D0-D8؛ تغطية معايير: 46/55
- open_issue: معايير أساسية بلا اختبار: C091
- owner: مسؤول الجودة
- required_action: إضافة حالات اختبار للمعايير المذكورة
