...
export type StatusVariant = "neutral" | "info" | "success" | "warning" | "attention" | "locked";
...
export const STATUS_VARIANT_CLASSES: Record<StatusVariant, string> = {
  ...
  info: "bg-himam-info-soft text-himam-info border-himam-info/30",
  success: "bg-himam-success-soft text-himam-success border-himam-success/30",
  warning: "bg-himam-warning-soft text-himam-warning-foreground border-himam-warning/40",
  attention: "bg-himam-attention-soft text-himam-attention border-himam-attention/40",
  locked: "bg-himam-locked-soft text-himam-locked-foreground border-himam-locked/30",
};
